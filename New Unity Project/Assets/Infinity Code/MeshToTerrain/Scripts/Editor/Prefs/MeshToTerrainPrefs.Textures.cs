...
namespace InfinityCode.MeshToTerrain
{
    public partial class MeshToTerrainPrefs
    {
        ...
        private void HugeTextureUI()
        {
            ...
            if (GUILayout.Button("Download Huge Texture")) Process.Start("https://assetstore.unity.com/packages/tools/input-management/huge-texture-163576");
#endif
        }
        ...
        private void RegularTextureUI()
        {
            ...
            if (textureCaptureMode == MeshToTerrainTextureCaptureMode.camera)
            {
                ...
                if (!adjustMeshSize) EditorGUILayout.HelpBox("Texture Capture Mode - Camera requires Adjust size of meshes - ON.", MessageType.Warning);
