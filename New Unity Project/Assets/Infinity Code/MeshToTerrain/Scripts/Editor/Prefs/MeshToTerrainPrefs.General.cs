...
namespace InfinityCode.MeshToTerrain
{
    public partial class MeshToTerrainPrefs
    {
        ...
        {
            Process.Start("https://infinity-code.com/products/mesh-to-terrain");
        }
        ...
        private static void ToolbarHelpUI(GUIStyle buttonStyle)
        {
            ...
            menu.AddItem(new GUIContent("Documentation"), false, OpenDocs);
            menu.AddItem(new GUIContent("Forum"), false, OpenForum);
