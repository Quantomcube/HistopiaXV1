...
namespace InfinityCode.uContext.Windows
{
    public class ObjectWindow : AutoSizePopupWindow
    {
        ...
        private Type assetImporterEditorType;
        ...
        protected override void OnContentGUI()
        {
            if (editor == null)
            {
                ...
                assetImporterEditorType = EditorTypes.assetImporterEditor;
            }
            ...
            if (editor != null)
            {
                ...
                if (drawInspector)
                {
                    ...
                    if (assetImporterEditorType != null && editor.GetType().IsSubclassOf(assetImporterEditorType))
                    {
                        EditorGUILayout.BeginHorizontal();
                        EditorGUILayout.Space();
                        Reflection.InvokeMethod(EditorTypes.textureImporterInspector, "OnApplyRevertGUI", editor);
        ...
        public static ObjectWindow ShowPopup(Object[] targets, Rect? rect = null, string title = null)
        {
            ...
            PinAndClose.Show(wnd, r, wnd.Close, title);
