...
namespace InfinityCode.uContext
{
    public partial class Prefs
    {
        ...
        public static bool quickAccessBarProGidMode = false;
        ...
        public class QuickAccessBarManager : StandalonePrefManager<QuickAccessBarManager>
        {
            ...
            public override void Draw()
            {
                ...
                quickAccessBarProGidMode = EditorGUILayout.ToggleLeft("ProGrid Compatibility Mode", quickAccessBarProGidMode, EditorStyles.label);
                ...
                if (GUILayout.Button("Collapse All"))
                {
                    ...
                    EditorReflected.ClearReorderableListCache(reorderableList);
                }
            ...
            private void WaitWindowChanged()
            {
                ...
                if (wnd == null) return;
                if (wnd.GetType() == EditorTypes.projectSettingsWindow) return;
